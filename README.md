...
[setup with a personal config repository](https://github.com/ut-issl/issl-ubuntu-environment-setup/blob/v0.8.3/docs/11-setup-with-a-personal-config-repository.md).
...
```console
bash <(curl -fsSL https://github.com/ut-issl/issl-ubuntu-environment-setup/releases/download/v0.8.3/bootstrap-host.sh)
```
...
> See [package management practices](https://github.com/ut-issl/issl-ubuntu-environment-setup/blob/v0.8.3/docs/13-package-management-practices.md#unfree-packages).
...
> See [package management practices](https://github.com/ut-issl/issl-ubuntu-environment-setup/blob/v0.8.3/docs/13-package-management-practices.md#gui-applications)
